...
class Oscar < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/JacksonJRay/oscar/releases/download/v0.1.3/oscar-v0.1.3-aarch64-apple-darwin.tar.gz"
      # Update from release SHA256SUMS after tagging:
      sha256 "REPLACE_WITH_SHA256_FROM_RELEASE_SHA256SUMS"
    end
    on_intel do
      url "https://github.com/JacksonJRay/oscar/releases/download/v0.1.3/oscar-v0.1.3-x86_64-apple-darwin.tar.gz"
      sha256 "REPLACE_WITH_SHA256_FROM_RELEASE_SHA256SUMS"
    end
  end
  ...
  on_linux do
    on_arm do
      url "https://github.com/JacksonJRay/oscar/releases/download/v0.1.3/oscar-v0.1.3-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "REPLACE_WITH_SHA256_FROM_RELEASE_SHA256SUMS"
    end
    on_intel do
      url "https://github.com/JacksonJRay/oscar/releases/download/v0.1.3/oscar-v0.1.3-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "REPLACE_WITH_SHA256_FROM_RELEASE_SHA256SUMS"
    end
  end
